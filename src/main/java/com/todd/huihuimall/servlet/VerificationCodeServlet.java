...
public class VerificationCodeServlet extends HttpServlet {
    // 被存放到session中的正确验证码奖杯存放在哪个session-key中?
    private static final String CorrectVerificationCodeKey = "correctVerificationCode";
    ...
    public void doGet(HttpServletRequest request,HttpServletResponse response) throws IOException{
        ...
        request.getSession().setAttribute(CorrectVerificationCodeKey,sb.toString()); //将数字保留在session中，便于后续的使用
