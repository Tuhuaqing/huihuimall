...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/error/style/bootstrap.min.css">
    <link rel="stylesheet" href="<%=request.getContextPath()%>/error/style/style.css">
    <script src="<%=request.getContextPath()%>/error/style/gsap.min.js"></script>
    <script src="<%=request.getContextPath()%>/error/style/script.js"></script>
</head>
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 align-self-center">
                ...
                <h2>2秒后自动跳转</h2>
                <%--                <a href="https://404.life/"><button class="btn green">返回首页</button></a>--%>
            </div>
        </div>
    </div>
</main>
