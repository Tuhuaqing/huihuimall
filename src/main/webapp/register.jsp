    ...
    <div class="w1230">
        <div class="reg-div">
            ...
            <form action="register" method="post">
                <p><input type="text" name="username" placeholder="请输入注册的账号" required/></p>
                <p><input type="password" name="password" placeholder="请输入密码" required/></p>
                <p><input type="password" placeholder="请确认密码" required/></p>
                <p class="clear-float">
                    <input type="text" name="verificationCode" placeholder="验证码" class="code" required/>
                    <img id="verificationCode"
                         src="<%=request.getContextPath()+"/verificationCode"%>" onclick="reLoadCode()" width="110px"
                         height="42px" class="code-img"/>
                </p>
